...
public:
   RGWHandler_REST_Service_S3(const rgw::auth::StrategyRegistry& auth_registry,
                              bool isSTSenabled, bool isIAMenabled, bool isPSenabled) :
     RGWHandler_REST_S3(auth_registry), isSTSenabled(isSTSenabled), isIAMenabled(isIAMenabled), isPSenabled(isPSenabled) {}
...
private:
  ...
  bool enable_pubsub;
public:
  explicit RGWRESTMgr_S3(bool enable_s3website = false, bool enable_sts = false, bool enable_iam = false, bool enable_pubsub = false)

...
class Aio {
 public:
  ...
  static OpFunc remote_op(librados::ObjectReadOperation&& op, boost::asio::io_context& context, optional_yield y,
                         ...
                         //I think we have a second remote_op with "string Location" instead of "string dest"
};

...
TEST_F(IPPolicyTest, EvalIPAddress) {
  ...
  blacklistedIP.emplace("aws:SourceIp", "192.168.1.1");
  blacklistedIPv6.emplace("aws:SourceIp", "2001:0db8:85a3:0000:0000:8a2e:0370:7334");
  ...
  ARN arn4(Partition::aws, Service::s3,
			    "", arbitrary_tenant, "example_bucket");
  EXPECT_EQ(allowp.eval(blacklistedIPv6, trueacct, s3ListBucket, arn4),
	    Effect::Pass);
  ...
  ARN arn7(Partition::aws, Service::s3,
			   "", arbitrary_tenant, "example_bucket");
  EXPECT_EQ(denyp.eval(blacklistedIP, trueacct, s3ListBucket, arn7),
	    Effect::Pass);
  ARN arn8(Partition::aws, Service::s3,
			   "", arbitrary_tenant, "example_bucket/myobject");
  EXPECT_EQ(denyp.eval(blacklistedIP, trueacct, s3ListBucket, arn8),
	    Effect::Pass);

  ARN arn9(Partition::aws, Service::s3,
			   "", arbitrary_tenant, "example_bucket");
  EXPECT_EQ(denyp.eval(blacklistedIPv6, trueacct, s3ListBucket, arn9),
	    Effect::Pass);
  ARN arn10(Partition::aws, Service::s3,
			   "", arbitrary_tenant, "example_bucket/myobject");
  EXPECT_EQ(denyp.eval(blacklistedIPv6, trueacct, s3ListBucket, arn10),
	    Effect::Pass);
  ARN arn11(Partition::aws, Service::s3,
			   "", arbitrary_tenant, "example_bucket");
  ...
  ARN arn15(Partition::aws, Service::s3,
			   "", arbitrary_tenant, "example_bucket");
  EXPECT_EQ(fullp.eval(blacklistedIP, trueacct, s3ListBucket, arn15),
	    Effect::Pass);
  ARN arn16(Partition::aws, Service::s3,
			   "", arbitrary_tenant, "example_bucket/myobject");
  EXPECT_EQ(fullp.eval(blacklistedIP, trueacct, s3ListBucket, arn16),
	    Effect::Pass);
  ...
  ARN arn19(Partition::aws, Service::s3,
			   "", arbitrary_tenant, "example_bucket");
  EXPECT_EQ(fullp.eval(blacklistedIPv6, trueacct, s3ListBucket, arn19),
	    Effect::Pass);
  ARN arn20(Partition::aws, Service::s3,
			   "", arbitrary_tenant, "example_bucket/myobject");
  EXPECT_EQ(fullp.eval(blacklistedIPv6, trueacct, s3ListBucket, arn20),
	    Effect::Pass);
}

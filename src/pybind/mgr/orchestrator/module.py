...
class OrchestratorCli(OrchestratorClientMixin, MgrModule,
    ...
    def _drain_host(self, hostname: str, force: bool = False, zap_osd_devices: bool = False) -> HandleCommandResult:
        """drain all daemons from a host"""
        completion = self.drain_host(hostname, force, zap_osd_devices)
        raise_if_exception(completion)
        return HandleCommandResult(stdout=completion.result_str())

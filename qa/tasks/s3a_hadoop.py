...
def task(ctx, config):
    ...
    if hadoop_ver.startswith('2.8'):
        ...
        test_options = '-Dit.test=ITestS3A* -Dtest=\!ITestS3AAWSCredentialsProvider.testAnonymousProvider -Dparallel-tests -Dscale -Dfs.s3a.scale.test.huge.filesize=128M verify'
    else:
